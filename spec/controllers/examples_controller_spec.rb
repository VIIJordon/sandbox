  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved example as @example" do
        ...
        post :create, {:example => { "name" => "invalid value" }}, valid_session
        assigns(:example).should be_a_new(Example)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested example" do
        ...
        Example.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => example.to_param, :example => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the example as @example" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Example.any_instance.stub(:save).and_return(false)
        put :update, {:id => example.to_param, :example => { "name" => "invalid value" }}, valid_session
        assigns(:example).should eq(example)
      end
